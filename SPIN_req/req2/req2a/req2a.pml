/*Reachability
There is a screen (root), such that each screen is reachable from it:
*/
...
ltl req2{[](
(((state==screen2)-><>(state==screen3))&&((state==screen2)-><>(state==screen1)))||
(((state==screen1)-><>(state==screen3))&&((state==screen2)-><>(state==screen1)))||
(((state==screen3)-><>(state==screen1))&&((state==screen2)-><>(state==screen1)))
)}
