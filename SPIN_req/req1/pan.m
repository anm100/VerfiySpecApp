...
{	static int reported11 = 0;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC vm */
	case 6: /* STATE 1 - req1.pml:7 - [((state==BoPo_MainSreen))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][1] = 1;
		if (!((now.state==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: /* STATE 2 - req1.pml:9 - [state = CreateNewEvent] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 8: /* STATE 6 - req1.pml:11 - [((state==CreateNewEvent))] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][6] = 1;
		if (!((now.state==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 9: /* STATE 7 - req1.pml:13 - [state = BoPo_MainSreen] (0:0:1 - 1) */
		IfNotBlocked
		reached[0][7] = 1;
		(trpt+1)->bup.oval = now.state;
		now.state = 2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 10: /* STATE 14 - req1.pml:16 - [-end-] (0:0:0 - 1) */
		IfNotBlocked
		reached[0][14] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
