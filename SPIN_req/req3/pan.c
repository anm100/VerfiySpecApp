...
{	int j, h = now._nr_pr;
	...
	case 4:	/* claim select */
		...
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim r3 (1), from state 9\n");
#endif
		if (whichclaim != -1)
...
{
	switch (x) {
	case 1: Printf("CreateNewEvent"); break;
	case 2: Printf("enterWemail"); break;
	case 3: Printf("enterWuser"); break;
	case 4: Printf("changeParamEmail"); break;
	case 5: Printf("changeParamUserName"); break;
	case 6: Printf("SignIn"); break;
	case 7: Printf("BoPo_MainSreen"); break;
	default: Printf("%d", x);
	}
}
void
