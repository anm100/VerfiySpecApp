...
{	int j, h = now._nr_pr;
	...
	case 4:	/* claim select */
		...
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim r7 (1), from state 5\n");
#endif
		if (whichclaim != -1)
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			logval("actions[l_in]", now.actions[l_in]);
		}
	}
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
			printf("	byte   actions[%d]:	%d\n", l_in, now.actions[l_in]);
		}
	}
...
{
	switch (x) {
	case 1: Printf("ChangeWif"); break;
	case 2: Printf("changebluParam"); break;
	case 3: Printf("ChangeWifi"); break;
	case 4: Printf("ChangeAirplaneMode"); break;
	case 5: Printf("ChangePasswordParm"); break;
	case 6: Printf("ChangeusernameParm"); break;
	case 7: Printf("NotificationScreen"); break;
	case 8: Printf("RequestToCreateNewCategoryScreen"); break;
	case 9: Printf("ChooseLocationScreen"); break;
	case 10: Printf("ChangePasswordScreen"); break;
	case 11: Printf("CreateNewEvent"); break;
	case 12: Printf("aboutUsScreen"); break;
	case 13: Printf("SettingScreen"); break;
	case 14: Printf("ProfileScreen"); break;
	case 15: Printf("CallingScreen"); break;
	case 16: Printf("PersonScreen"); break;
	case 17: Printf("PersonaScreen"); break;
	case 18: Printf("GetARide"); break;
	case 19: Printf("GiveARide"); break;
	case 20: Printf("EventScreen"); break;
	case 21: Printf("Notification"); break;
	case 22: Printf("MyEventScreen"); break;
	case 23: Printf("BoPo_MainSreen"); break;
	case 24: Printf("PendingNewRequestScreen"); break;
	case 25: Printf("AddNewCategory"); break;
	case 26: Printf("ManageAppScreen"); break;
	case 27: Printf("SearchScreen"); break;
	case 28: Printf("RegisterScreen"); break;
	case 29: Printf("LoginScreen"); break;
	default: Printf("%d", x);
	}
}
void
