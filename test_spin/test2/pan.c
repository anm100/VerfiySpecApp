...
{	int j, h = now._nr_pr;
	...
	case 4:	/* claim select */
		...
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim req8 (1), from state 9\n");
#endif
		if (whichclaim != -1)
...
printm(int x)
{
	...
	case 4: Printf("changeBluetoothOFF"); break;
	case 5: Printf("changeWifiON"); break;
	case 6: Printf("changeBluetoothON"); break;
	case 7: Printf("LoginScreen"); break;
