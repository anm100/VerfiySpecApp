...
{	Trans *T;
	...
	T = trans[1][9] = settr(194,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(194,0,1,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(194,0,3,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(194,0,5,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(194,0,7,0,0,"IF", 0, 2, 0);
	trans[1][1]	= settr(186,0,15,3,0,"((!(!((Airplane_mode==1)))&&!((Wifi==0))))", 1, 2, 0);
	trans[1][2]	= settr(187,0,15,1,0,"goto accept_S5", 0, 2, 0);
	trans[1][10]	= settr(195,0,15,1,0,".(goto)", 0, 2, 0);
	trans[1][3]	= settr(188,0,23,4,0,"((((!(!((Airplane_mode==1)))&&!((((state==changeAirplane_modeON)||(state==changeWifiOFF))||(state==changeBluetoothOFF))))&&!((Bluetooth==0)))||((!(!((Airplane_mode==1)))&&!((((state==changeAirplane_modeON)||(state==changeWifiOFF))||(state==changeBluetoothOFF))))&&!((Wifi==0)))))", 1, 2, 0);
	trans[1][4]	= settr(189,0,23,1,0,"goto accept_all", 0, 2, 0);
	trans[1][5]	= settr(190,0,21,5,0,"((!(!((Airplane_mode==1)))&&!((Bluetooth==0))))", 1, 2, 0);
	trans[1][6]	= settr(191,0,21,1,0,"goto accept_S10", 0, 2, 0);
	trans[1][7]	= settr(192,0,9,1,0,"(1)", 0, 2, 0);
	trans[1][8]	= settr(193,0,9,1,0,"goto T0_init", 0, 2, 0);
	T = trans[1][15] = settr(200,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(200,0,11,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(200,0,13,0,0,"IF", 0, 2, 0);
	trans[1][11]	= settr(196,0,15,6,0,"(!((Wifi==0)))", 1, 2, 0);
	trans[1][12]	= settr(197,0,15,1,0,"goto accept_S5", 0, 2, 0);
	trans[1][16]	= settr(201,0,21,1,0,".(goto)", 0, 2, 0);
	trans[1][13]	= settr(198,0,23,7,0,"((!((((state==changeAirplane_modeON)||(state==changeWifiOFF))||(state==changeBluetoothOFF)))&&!((Wifi==0))))", 1, 2, 0);
	trans[1][14]	= settr(199,0,23,1,0,"goto accept_all", 0, 2, 0);
	T = trans[1][21] = settr(206,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(206,0,17,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(206,0,19,0,0,"IF", 0, 2, 0);
	trans[1][17]	= settr(202,0,21,8,0,"(!((Bluetooth==0)))", 1, 2, 0);
	trans[1][18]	= settr(203,0,21,1,0,"goto accept_S10", 0, 2, 0);
	trans[1][22]	= settr(207,0,23,1,0,".(goto)", 0, 2, 0);
	trans[1][19]	= settr(204,0,23,9,0,"((!((((state==changeAirplane_modeON)||(state==changeWifiOFF))||(state==changeBluetoothOFF)))&&!((Bluetooth==0))))", 1, 2, 0);
	trans[1][20]	= settr(205,0,23,1,0,"goto accept_all", 0, 2, 0);
	trans[1][23]	= settr(208,0,24,1,0,"(1)", 0, 2, 0);
	trans[1][24]	= settr(209,0,0,10,10,"-end-", 0, 3500, 0);
	...
	trans[0][1]	= settr(0,0,36,11,0,"((state==Setting))", 1, 2, 0);
	...
	trans[0][3]	= settr(2,0,183,13,13,"Airplane_mode = 1", 1, 2, 0); /* m: 4 -> 0,183 */
	reached0[4] = 1;
	...
	trans[0][10]	= settr(9,0,183,15,15,"Airplane_mode = 0", 1, 2, 0); /* m: 11 -> 0,183 */
	reached0[11] = 1;
	...
	trans[0][15]	= settr(14,0,183,17,17,"Bluetooth = 1", 1, 2, 0); /* m: 16 -> 0,183 */
	reached0[16] = 1;
	...
	trans[0][20]	= settr(19,0,183,19,19,"Bluetooth = 0", 1, 2, 0); /* m: 21 -> 0,183 */
	reached0[21] = 1;
	...
	trans[0][25]	= settr(24,0,183,21,21,"Wifi = 1", 1, 2, 0); /* m: 26 -> 0,183 */
	reached0[26] = 1;
	...
	trans[0][30]	= settr(29,0,183,23,23,"Wifi = 0", 1, 2, 0); /* m: 31 -> 0,183 */
	reached0[31] = 1;
	...
	trans[0][34]	= settr(33,0,183,24,24,"state = Setting", 1, 2, 0);
	trans[0][38]	= settr(37,0,52,25,0,"((state==LoginScreen))", 1, 2, 0);
	...
	trans[0][39]	= settr(38,0,43,26,0,"((pass==2))", 1, 2, 0);
	T = trans[ 0][43] = settr(42,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(42,2,40,0,0,"ATOMIC", 1, 2, 0);
	trans[0][40]	= settr(39,0,183,27,27,"pass = 3", 1, 2, 0); /* m: 41 -> 0,183 */
	reached0[41] = 1;
