...
{	Trans *T;
	...
	T = trans[1][5] = settr(18,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(18,0,1,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(18,0,3,0,0,"IF", 0, 2, 0);
	trans[1][1]	= settr(14,0,9,3,0,"(!(!((state==BoPo_MainSreen))))", 1, 2, 0);
	trans[1][2]	= settr(15,0,9,1,0,"goto accept_S4", 0, 2, 0);
	trans[1][6]	= settr(19,0,9,1,0,".(goto)", 0, 2, 0);
	trans[1][3]	= settr(16,0,5,1,0,"(1)", 0, 2, 0);
	trans[1][4]	= settr(17,0,5,1,0,"goto T0_init", 0, 2, 0);
	T = trans[1][9] = settr(22,0,0,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(22,0,7,0,0,"IF", 0, 2, 0);
	trans[1][7]	= settr(20,0,9,4,0,"(!(!((state==BoPo_MainSreen))))", 1, 2, 0);
	trans[1][8]	= settr(21,0,9,1,0,"goto accept_S4", 0, 2, 0);
	trans[1][10]	= settr(23,0,11,1,0,".(goto)", 0, 2, 0);
	trans[1][11]	= settr(24,0,0,5,5,"-end-", 0, 3500, 0);
	...
	trans[0][1]	= settr(0,0,4,6,0,"((state==BoPo_MainSreen))", 1, 2, 0);
	...
	trans[0][2]	= settr(1,0,11,7,7,"state = BoPo_MainSreen", 1, 2, 0);
	trans[0][5]	= settr(4,0,11,1,0,".(goto)", 0, 2, 0);
	trans[0][6]	= settr(5,0,9,8,0,"((state==CreateNewEvent))", 1, 2, 0);
	...
	trans[0][7]	= settr(6,0,11,9,9,"state = BoPo_MainSreen", 1, 2, 0);
