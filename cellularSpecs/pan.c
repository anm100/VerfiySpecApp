...
{	int j, h = now._nr_pr;
	...
	case 5:	/* claim select */
		...
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim req1_1 (1), from state 7\n");
#endif
		if (whichclaim != -1)
...
{
	switch (x) {
	case 1: Printf("changeWifiOFF"); break;
	case 2: Printf("changeAirplane_modeON"); break;
	case 3: Printf("changeAirplane_modeOFF"); break;
	case 4: Printf("changeuserNotEmpty"); break;
	case 5: Printf("changeBluetoothOFF"); break;
	case 6: Printf("changepassNotEmpty"); break;
	case 7: Printf("changeWifiON"); break;
	case 8: Printf("changeBluetoothON"); break;
	case 9: Printf("MainScreen"); break;
	case 10: Printf("LoginScreen"); break;
	case 11: Printf("Setting"); break;
	default: Printf("%d", x);
	}
}
void
