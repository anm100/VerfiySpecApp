...
ltl  req1 {[](((state==Setting)->((!([]<>((state==changeBluetoothON)||
(state==changeWifiON)||(state==changepassNotEmpty)||(state==changeBluetoothOFF)||
(state==changeuserNotEmpty)||(state==changeAirplane_modeOFF)||(state==changeAirplane_modeON)||
(state==changeWifiOFF))))-><>((state !=Setting)&&)))
active proctype vm(){
 do
/*
*/////////////////////////////////////// ---screen: Setting////////////////////////////////////////////////
